...
│   ├── Product/                      # Product catalog, inventory, stock management
│   ├── Orders/                       # Order management
│   ├── CRM/                          # Customer relationship management
│   ├── BusinessType/                 # Industry packs, tenant config engine
│   ├── Onboarding/                   # Registration pipeline, tenant provisioning
│   └── (future modules)
...
│   └── (auto-generated by @laravel/vite-plugin-wayfinder on save, do not edit)
...
│   │   └── components/
│   │       └── industry-widgets.tsx  # Industry-specific widgets
│   ├── product/                      # Product module frontend
│   ├── billing/                      # Billing module frontend
...
│   ├── shared/                       # Shared-tenant migrations (souda_shared)
│   │   └── 2026_02_22_094519_...     # Shared: tasks, tenant_configs, etc.
│   └── tenant/                       # Dedicated-tenant migrations
├── seeders/
│   ├── DatabaseSeeder.php
│   ├── PlanSeeder.php
│   └── (module seeders)
